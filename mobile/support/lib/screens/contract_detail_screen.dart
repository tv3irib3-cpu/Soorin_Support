...
/// جزئیاتِ قرارداد — نوع، درصدهای پوشش، سقف/مانده، و شمارِ تیکت/فاکتور.
...
class _ContractDetailScreenState extends State<ContractDetailScreen> {
        ...
        children: [
          Card(child: Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (c['customer'] != null) _kv(Icons.business, 'مشتری', c['customer']),
              ...
              if (c['used_amount_fa'] != null) _kv(Icons.trending_up, 'مصرف‌شده', c['used_amount_fa']),
          ...
          Row(children: [
            Expanded(child: _statCard(Icons.confirmation_number_outlined, 'تیکت‌ها', '${_data!['tickets_count'] ?? 0}')),
            const SizedBox(width: 10),
            Expanded(child: _statCard(Icons.receipt_long_outlined, 'فاکتورها', '${_data!['invoices_count'] ?? 0}')),
          ]),
          if (c['notes'] != null) ...[
  ...
  Widget _statCard(IconData icon, String label, String value) => Card(child: Padding(
        padding: const EdgeInsets.all(14),
        child: Row(children: [
