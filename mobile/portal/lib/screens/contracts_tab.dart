...
/// تبِ قراردادهای مشتری — قراردادهای شرکتِ خودِ کاربر.
  ...
  Widget build(BuildContext context) {
    if (_error != null) {
      return Center(child: Padding(padding: const EdgeInsets.all(24), child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        const SizedBox(height: 12), FilledButton(onPressed: _load, child: const Text('تلاشِ دوباره')),
      ])));
    }
    ...
    return Card(
      child: ListTile(
        ...
        subtitle: Padding(
          ...
          child: Text('${c['plan'] ?? '—'} • ${c['start_date']} تا ${c['end_date']}', style: const TextStyle(fontSize: 12)),
        ),
      ),
    );
  }
