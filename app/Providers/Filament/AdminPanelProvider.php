    ...
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->renderHook(
                ...
                // مستقیم inline (نه لینک به فایل) — چون روی LiteSpeed مسیر/فایلِ .css گاهی ۴۰۴ می‌شد.
                fn (): string => '<style>' . (string) @file_get_contents(resource_path('css/theme.css')) . '</style>',
            )
            ->renderHook(
