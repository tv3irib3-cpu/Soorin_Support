...
class TicketObserver
{
    public function creating(Ticket $ticket): void
    {
        ...
        // سازندهٔ تیکت — اگر از پرتال ست شده باشد دست نمی‌خورد؛ برای تیکتی که پشتیبان
        // از پنل می‌سازد، کاربرِ واردشده ثبت می‌شود تا «خروجی» شناخته شود.
        if (blank($ticket->created_by) && auth()->check()) {
