...
return [
    ...
    'app' => [
        ...
        'version' => '0.4.10',        // سازگاری عقب‌رو — نسخهٔ واقعی از فایل VERSION خوانده می‌شود
    ],
    ...
    */
    ...
    |
    | اگر این آدرس تنظیم شود، «به‌روزرسانی» به‌جای git/composer، یک بستهٔ آمادهٔ ZIP
    | (همراهِ vendor) را از این «مانیفست» می‌گیرد و کاملاً با PHP اعمال می‌کند —
    | پس روی هاستِ اشتراکیِ بدونِ SSH هم کار می‌کند.
    |
    | مانیفست یک JSON است در یک URLِ عمومی:
    |   {"version":"0.4.5","zip":"https://…/soorin-support-0.4.5.zip","sha256":"…","notes":"…"}
    | با اسکریپتِ deploy/build-package.sh ساخته و هرجا (هاستِ خودت، یک فضای عمومی، …) میزبانی می‌شود.
    */
    'update' => [
        'manifest' => env('APP_UPDATE_MANIFEST'),
    ],
];
