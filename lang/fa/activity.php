...
return [
    ...
    'actions' => [
        ...
        'log_cleared'    => 'پاک‌کردن تاریخچه',
    ],

    'clear'         => 'پاک‌کردن تاریخچه',
    'clear_confirm' => 'همهٔ رویدادهای تاریخچهٔ تغییرات حذف می‌شوند. این کار برگشت‌ناپذیر است. ادامه می‌دهید؟',
    'cleared'       => 'تاریخچهٔ تغییرات پاک شد.',
